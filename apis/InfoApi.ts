...
export class InfoApiRequestFactory extends BaseAPIRequestFactory {
    ...
    /**
     */
    public async appControllerGetInfo(options?: Configuration): Promise<RequestContext> {
    ...
    /**
     */
    public async appControllerGetRegistration(options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
    ...
    /**
     */
    public async appControllerHealth(options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
